...
CREATE TABLE IF NOT EXISTS med_assignments (
    ...
    dose_fraction TEXT CHECK (dose_fraction IN ('whole', 'half', 'quarter', 'three_quarter', 'eighth', 'sixteenth')),
    liquid_dose_ml REAL,
...
CREATE TABLE IF NOT EXISTS med_intake_records (
    ...
    dose_fraction_override TEXT CHECK (dose_fraction_override IN ('whole', 'half', 'quarter', 'three_quarter', 'eighth', 'sixteenth')),
