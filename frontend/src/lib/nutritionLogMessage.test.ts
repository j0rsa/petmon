...
describe('formatLoggedNutritionMessage', () => {
  it('formats a wet + liquid pair casually', () => {
    const payloads: CreateNutritionRecord[] = [
      { pet_id: 'p', occurred_at: '2024-06-15T12:00:00Z', category: 'wet_food', amount: 76, unit: 'g' },
      { pet_id: 'p', occurred_at: '2024-06-15T12:00:00Z', category: 'liquids', amount: 40, unit: 'ml' },
    ];
  ...
  it('formats a single category', () => {
    const payloads: CreateNutritionRecord[] = [
      { pet_id: 'p', occurred_at: '2024-06-15T12:00:00Z', category: 'water', amount: 50, unit: 'ml' },
    ];
