...
import { withNutritionDayPanel, withSelectedPet } from '../stories/decorators';
...
export const WithRecords: Story = {
  decorators: [withSelectedPet(), withNutritionDayPanel('2024-06-15', mockPetId)],
};
...
export const EmptyDay: Story = {
  ...
  decorators: [withSelectedPet(), withNutritionDayPanel('2024-06-16', mockPetId, true)],
};
